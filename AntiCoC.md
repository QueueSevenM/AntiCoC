# The Anti Code of Conduct, Version 1.0

## Preamble

The 'Code of Conduct' is a recent development in the world of software-development that claims to address the self-proclaimed issues in software development environments with the enforcement of a supposedly universally-agreeable set of standards for participants. In reality, CoCs are used as a political bludgeon to force the support of highly unpopular activist causes upon contributors, and the removal of contributors who don't agree with these views. The so-called issues CoCs claim to address almost always don't exist in the first place, with the only issues within development workplaces often arising specifically because of the introduction of a CoC, which are in turn used to justify even stricter CoCs and more crackdowns against the views that the activists are offended by.

The AntiCoC on the other hand, seeks to do exactly the opposite. The only behavior we find unacceptable is attempts at forcing contributors to adhere to unrelated and unpopular activist causes.

## Terms

1. At no point will I utilize or attempt to utilize this project, or any of its affiliated communication and coordination channels, for any cause that is not related to the development and improvement of this project or related projects and technologies; especially for the promotion of unrelated activist causes and ideologies.
2. At no point will I attempt to target or 'cancel' any of the contributors to this project with the intent of their removal or alienation from the project for views unrelated to the development of the project or disciplines used by this project when in intersection with the project. This includes both through official channels, and on external platforms and in real-life. ("When in intersection with the project" meaning where the discipline is utilized within the project and is the primary point of focus. For example, the design of icons in an application intersects with the project. However, someone's views on art do not, even in the context of developing an art program.)
...
### What if this makes me feel discriminated against?
...
### Without a CoC, how would I possibly feel safe engaging in your community? How would I raise a red flag if I am mistreated?
...
### If you don't have a CoC, this will surely be the end of your project, and the end of some talented individuals contributing to it!
...
### What about non-internet communications, such as a place of work, or a conference?
...
### Without a CoC, how would this community be welcoming to newcomers, and not become vile, intimidating, or have some other type of unwelcome agenda?
...
### Your name is offensive. CoC sounds like Cock, and I feel that this is a group of white males that is trying to downplay the seriousness of this issue in our community, and I boycott your movement, and am going to tell others to as well!

That wasn't really a question, but we will answer it anyways. This is an example of starting a fire where there does not need to be one. Try to be more tolerant of others and not read into their deep inner views. We have said clearly over and over that we don't care who you are, where you come from, or where you're going. We value intelligent discussion on our topic, and that's it. If you want to not use any community that adopts AntiCoC, that is fine. But please do listen to the content, and do not read too far in-between the lines. It simply stands for Anti Code of Conduct.

### Oh no, it has definitely happened! Someone has treated me unfairly, and I'm 100% sure it's related to something about who I am, and not related to what I have said or contributed directly.
...
### What about off-topic chatter?

Off topic chatter should be discouraged, but not censored. AntiCoC is targeting things like open source projects and public online communities based around specific topics.

### How can I contribute to your project or community when I see someone said something on a different site or community which directly makes me feel awful?
...
### As a community manager or leader, what happens when the mob arrives, or when someone starts to engage in discussion that could lead to more endless discussion?
...
### WTF, the discussion was locked, and/or I can't reply!?
